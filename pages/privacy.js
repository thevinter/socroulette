        ...
        >
          <div style={{ width: '70%' }}>
            ...
            <ul>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to socroulette, accessible from{' '}
                  <a href="www.socroulette.com" rel="external nofollow noopener" target="_blank">
                    www.socroulette.com
                  </a>
                </p>
              </li>
            ...
            <ul>
              <li>By email: contact@thevinter.com</li>
            </ul>
          </div>
        </div>
      </div>
