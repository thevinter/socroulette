  ...
  return (
    <div className={styles.title}>
      ...
      <p className={styles.aboutPar}>
        Tired of searching through countless threads on 4chan /soc/ board to try
        and find your account among the hundreds already there? Now with
        socroulette, you can just leave it all up to the crowd. Just upload your
        accounts, and then aggregate them, searching for the one perfect match.
        The site is free, actively improved, and ad-free.
      </p>
      <p className={styles.aboutPar}>
        No registration is needed and every account is stored for 7 days, after
        which it is made inactive but can be reactivated at a later date.
      </p>
    </div>
  );
}
